	...
	<div class="topbar border-bottom bg-white">
		<nav class="navbar navbar-expand align-items-center container">
			<router-link to="/" class="text-decoration-none d-flex align-items-center">
				<img src="../../assets/images/logo_cua_du_an.png" class="logo-icon" style="width: 44px; height: 44px;" alt="logo">
			...
			<div class="ms-3 d-none d-md-block flex-grow-1">
				<div class="input-group">
					...
					<input type="text" class="form-control bg-light border-0" placeholder="Tìm kiếm khóa học, bài viết...">
					...
					<div class="dropdown">
						<a class="d-flex align-items-center nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							...
							<div class="user-info ps-2 text-start">
								...
								<p class="designattion mb-0 small text-muted">{{ user.email }}</p>
							</div>
						</a>
						<ul class="dropdown-menu dropdown-menu-end">
							<li>
								<router-link to="/tai-khoan" class="dropdown-item"><i class="bx bx-user me-2"></i><span>Profile</span></router-link>
							</li>
							<li><a v-on:click="logout()" class="dropdown-item" href="javascript:;"><i class='bx bx-log-out-circle me-2'></i><span>Đăng Xuất</span></a></li>
							<li><a v-on:click="logoutAll()" class="dropdown-item" href="javascript:;"><i class='bx bx-log-out-circle me-2'></i><span>Đăng Xuất Tất Cả</span></a></li>
						</ul>
					</div>
				</template>
				<template v-else>
					<router-link to="/khach-hang/dang-nhap" class="btn btn-outline-dark me-2 d-flex align-items-center">
						<i class="fa-regular fa-user me-2"></i>Đăng Nhập
					</router-link>
					<router-link to="/khach-hang/dang-ky" class="btn btn-dark d-flex align-items-center">
