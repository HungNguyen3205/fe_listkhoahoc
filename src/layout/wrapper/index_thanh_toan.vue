<template>
    <div class="wrapper">
        <div class="header-wrapper">
            <TopClientThanhToan></TopClientThanhToan>
        </div>
        <div class="page-wrapper mt-5 mb-0">
...
import TopClientThanhToan from "../components/TopClientThanhToan.vue";
import BotRocker from "../components/BotRocker.vue";
export default {
    name        :   "app",
    components  :   {
        TopClientThanhToan, BotRocker
    }
}
</script>
<style>
