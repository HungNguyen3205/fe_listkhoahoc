<template>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <input v-model="create.hinh_anh" type="text" class="form-control mb-2" />
                     <label class="mb-2">Tên Giáo Viên</label>
                    <input v-model="create.giao_vien" type="text" class="form-control mb-2" />
                    <label class="mb-2">Bản Nâng Cấp</label>
                    <select v-model="create.loai" class="form-control mb-2">
                        <option value="1">Pro</option>
                        <option value="0">Miễn Phí</option>
                    </select>
                    <label class="mb-2">Giá Bán</label>
                    <input v-model="create.gia_ban" type="number" class="form-control mb-2" />
                    <label class="mb-2">Giá Gốc</label>
                                ...
                                <template v-for="(value, index) in list" :key="index">
                                    <tr class="text-nowrap">
                                        ...
                                        <td class="text-center align-middle">
                                            <button v-on:click="Object.assign(del, value)" class="btn" data-bs-toggle="modal" data-bs-target="#moTaModal">
                                                <i class="fa-solid fa-circle-info"></i>
                                            </button>
                                        </td>
                                        <td class="align-middle">
                                            <button v-on:click="doiTrangThai(value)" v-if="value.tinh_trang == 1"
                                                class="btn btn-success w-100">Hiển
                                                thị</button>
                                            <button v-on:click="doiTrangThai(value)" v-else
                                                class="btn btn-warning w-100">Tạm Ngưng</button>
                                        </td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Cập Nhật Loại Khóa Học</h1>
                ...
                <div class="modal-body">
                    <div class="alert alert-danger border-0 bg-danger alert-dismissible fade show py-2">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-1">
                                <h6 class="mb-1 text-white">Bạn chắc chắc xóa Loại Khóa Học <b>{{
                                        del.ten_khoa_hoc }}</b> này chứ
                                    !!!</h6>
    ...
    <div class="modal fade" id="moTaModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Mô Tả Ngắn Loại Khóa Học</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
...
export default {
    ...
    data() {
        return {
            ...
            editorConfig: {
                plugins: [Bold, Essentials, Italic, Mention, Paragraph, Undo, Heading, BlockQuote, Font, Link, List, Alignment, Highlight, Image, FileRepository],
                toolbar: ['heading',
    ...
    methods: {
        ...
        timKiem() {
            axios
                .post("http://127.0.0.1:8000/api/admin/loai-khoa-hoc/tim-kiem", this.search, {
                    headers : {
        ...
        doiTrangThai(value) {
            axios
                .post("http://127.0.0.1:8000/api/admin/loai-khoa-hoc/change-status", value, {
                    headers : {
                        Authorization: 'Bearer ' + localStorage.getItem("key_admin")
                    }
                })
        ...
        capNhat(){
            axios
                .post("http://127.0.0.1:8000/api/admin/loai-khoa-hoc/update", this.edit, {
                    headers : {
                        Authorization: 'Bearer ' + localStorage.getItem("key_admin")
                    }
                })
        ...
        xoa(){
            axios
                .post("http://127.0.0.1:8000/api/admin/loai-khoa-hoc/delete", this.del, {
                    headers : {
                        Authorization: 'Bearer ' + localStorage.getItem("key_admin")
                    }
                })
        ...
        themMoi() {
            axios
                .post("http://127.0.0.1:8000/api/admin/loai-khoa-hoc/create", this.create, {
                    headers : {
                        Authorization: 'Bearer ' + localStorage.getItem("key_admin")
                    }
                })
