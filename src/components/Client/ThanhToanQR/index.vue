            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <img v-if="link_qr" :src="link_qr" alt="QR Thanh toán" class="img-fluid my-3" />
                        <p><b class="text-danger">Lưu ý</b>: Nếu đơn hàng của bạn không tự động kích hoạt sau 5 phút,
                            vui lòng liên hệ để được hỗ trợ.</p>
                    </div>
                </div>
            </div>
        </div>
