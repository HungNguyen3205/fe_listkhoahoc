<template>
    <div class="row">
        <div class="col-lg-12 text-center">
            <h2>BÀI VIẾT CỦA CHÚNG TÔI <i class="fa-regular fa-newspaper"></i>
            </h2>
            <p>Ney tổng hợp bài viết kiến thức lập trình, thông báo và tin tức</p>
        </div>
        <hr>
        <div class="col-lg-12">
            <div class="row mt-3">
...
export default {
    ...
    methods: {
        loadBaiViet() {
            axios
                .get("http://127.0.0.1:8000/api/bai-viet/data-open")
                .then((res) => {
